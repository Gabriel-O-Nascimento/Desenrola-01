...
import { normalizeTracking } from "../../utils/normalize";
...
export default function AcompanhamentoServicos() {
  ...
  useEffect(() => {
    api.getTrackingById(id)
      .then((response) => setService(normalizeTracking(response)))
      .catch((error) => {
  ...
  if (!service) {
    return (
      <section className="tracking-page">
        ...
        <p className="tracking-empty">Acompanhamento nao encontrado.</p>
      </section>
    );
  }
    ...
    <section className="tracking-page">
      ...
      <main className="tracking-content">
        ...
        <section className="tracking-section">
          <h2 className="tracking-section__title">Status da solicitacao</h2>
        ...
        <section className="tracking-detail-card">
          ...
          <div className="tracking-detail-card__block">
            <span className="tracking-detail-card__label">Descricao do problema:</span>
        ...
        <section className="tracking-summary" aria-label="Informacoes finais">
          <p>
            <Calendar aria-hidden="true" />
