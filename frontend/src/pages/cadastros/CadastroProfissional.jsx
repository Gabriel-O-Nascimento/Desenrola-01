  ...
  function validateField(name, value, data = formData) {
    ...
    switch (name) {
      ...
      case "serviceDescription":
        if (!fieldValue || fieldValue.length < 50) return "Descreva seus servicos com pelo menos 50 caracteres.";
        return "";
      ...
      <form className="user-register-form" onSubmit={handleSubmit} noValidate>
        <section className="professional-register-hero">
          ...
          <p className="professional-register-hero__text">
            Cadastre-se como profissional no Desenrola, receba solicitacoes de servicos e aumente suas oportunidades de trabalho.
          </p>
        </section>
        ...
        <section className="user-register-card">
          <h2 className="user-register-card__title">Informacoes do Servico</h2>
          ...
          <label className="service-request-field" htmlFor="professional-service-description">
            <span className="service-request-field__label">Descricao dos Servicos *</span>
            <textarea
              className="service-request-field__textarea"
              id="professional-service-description"
              name="serviceDescription"
              value={formData.serviceDescription}
              placeholder="Descreva os servicos que voce realiza, especialidades e tipos de atendimento."
              onChange={handleFieldChange}
              onBlur={handleFieldBlur}
        ...
        <section className="user-register-card">
          <h2 className="user-register-card__title">Experiencia Profissional</h2>

          <label className="service-request-field" htmlFor="professional-experience">
            <span className="service-request-field__label">Experiencia profissional</span>
            <textarea
              className="service-request-field__textarea service-request-field__textarea--small"
              id="professional-experience"
              name="professionalExperience"
              value={formData.professionalExperience}
              placeholder="Conte um pouco sobre sua experiencia, tempo de atuacao ou trabalhos realizados."
              onChange={handleFieldChange}
            />
          </label>
        </section>
        ...
        <section className="user-register-card">
          ...
          >
            ...
            <span className="user-register-upload__hint">PNG ou JPG ate 10MB</span>
          </button>
